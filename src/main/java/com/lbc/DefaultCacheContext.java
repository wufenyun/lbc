...
public class DefaultCacheContext implements CacheContext, BeanPostProcessor,ApplicationContextAware,
    ...
    public void afterPropertiesSet() throws Exception {
        if (null == applicationContext || null == applicationContext.getAutowireCapableBeanFactory()) {
            logger.error("null == beanFactory");
        }

        DefaultListableBeanFactory defaultListableBeanFactory = (DefaultListableBeanFactory) applicationContext.getAutowireCapableBeanFactory();
        defaultListableBeanFactory.registerSingleton("cache", cache);
